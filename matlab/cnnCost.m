function [cost, grad, preds] = cnnCost(theta,images,labels,ratio,numClasses,...
...
activationsSoftmax = Wd  * activationsPooledReshaped + bsxfun(@times,repmat(bd, 1, numImages),ratio');
